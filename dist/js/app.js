...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Map_js__ = __webpack_require__(7);
...
const map = new __WEBPACK_IMPORTED_MODULE_4__modules_Map_js__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
 ...
 class MobileMenu  {
     ...
     constructor() {
         this.mainMenu = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.main-menu');
         this.menuIcon = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.hamburger__menu-icon');
         this.menuLinks = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.main-menu__list a');
         this.events();
     }
     events() {
        this.menuIcon.click(
...
class Spinner  {
    constructor() {
        ...
        this.spinner = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.spinner');
        this.events();
    }
    events() {
   __WEBPACK_IMPORTED_MODULE_0_jquery___default.a(window).on('load',function() {
    var preloader = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.spinner');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_validation__ = __webpack_require__(5);
...
class Validation {
    constructor() {
        this.form = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.form-application');
        this.name = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#name');
        this.email = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#email');
        this.message = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#message');
        this.okButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup .order-popup__button');
        this.clearButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('button .button--transparent');
        this.SubmitButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('button.button--form');
        this.setupPopup();
        this.Validation();
        this.clearText();
    }
        ...
        this.SubmitButton.on('click','form-application button[type=submit]',function(event) {
            var isValid = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a(event.target).parents('.form-application').isValid();
            if(!isValid) {
                event.preventDefault();
            }
    ...
    showPopup() {
        let $orderPopup = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup');
        let $orderPopupContent = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup .order-popup__content');
    ...
    parseForm() {
        ...
        let info = {
            ...
            let $fullOrder = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a(`
    ...
    `);
      let dataToSend = {
        ...
        function onSuccess() {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup .order-popup__title').html('Спасибо за заявку');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup .order-popup__button').show();
            this.orderForm[0].reset();
        }

        function onError() {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup .order-popup__title').text('Ошибка отправки. Проверьте соединение или попробуйте позже.');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#order-popup .order-popup__button').show();
...
window.initMap=function() {
    var stylemap = new google.maps.StyledMapType(__webpack_require__(8));
